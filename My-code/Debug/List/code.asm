...
; 0000 0029     // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 002A     DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
; 0000 002B     // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 0035     // Function: Bit7=Out Bit6=In Bit5=In Bit4=In Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0036     DDRD=(1<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(128)
	OUT  0x11,R30
; 0000 0037     // State: Bit7=0 Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 003D     // Mode: Fast PWM top=0xFF
; 0000 003E     // OC0 output: Non-Inverted PWM
; 0000 003F     // Timer Period: 0.032 ms
; 0000 0040     // Output Pulse(s):
; 0000 0041     // OC0 Period: 0.032 ms Width: 0 us
; 0000 0042     TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (1<<WGM01) | (0<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(105)
	OUT  0x33,R30
...
; 0000 0049     // Clock value: 8000.000 kHz
; 0000 004A     // Mode: Fast PWM top=0xFF
; 0000 004B     // OC2 output: Non-Inverted PWM
; 0000 004C     // Timer Period: 0.032 ms
; 0000 004D     // Output Pulse(s):
; 0000 004E     // OC2 Period: 0.032 ms Width: 0 us
; 0000 004F     ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0050     TCCR2=(1<<PWM2) | (1<<COM21) | (0<<COM20) | (1<<CTC2) | (0<<CS22) | (0<<CS21) | (1<<CS20);
	LDI  R30,LOW(105)
	OUT  0x25,R30
